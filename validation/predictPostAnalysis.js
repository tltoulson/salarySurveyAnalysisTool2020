...
function predictPostAnalysisValue(response) {
    var otherCountry = {
        'Belgium': 89929,
        'Brazil ': 72000,
        'Bulgaria': 107899,
...
function predictPostAnalysis(response) {
    var predicted = predictPostAnalysisValue(response);

    if (response.Gender == 'Female') {
        predicted = predicted * 0.87;
    }

    if (response.Ethnicity == 'Black, African or Caribbean') {
        predicted = predicted * 0.84;
    }
